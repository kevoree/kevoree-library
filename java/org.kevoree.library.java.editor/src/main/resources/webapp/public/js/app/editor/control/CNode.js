define(
    ...
    function(KNode, KGroup, UINode, UINodeProps, AController, CNestableEntity, UpdateModelVisitor, Kevoree, Pooffs) {
        ...
        function CNode(editor, type, version) {
            // CNestableEntity.super(editor, type)
            CNestableEntity.prototype.constructor.call(this, editor, type, version);

            // KNode.super(editor, type)
            KNode.prototype.constructor.call(this, editor, type, version);
