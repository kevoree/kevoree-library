...
{
buf.push("<li" + (jade.attrs({ 'data-entity':(item.type), 'data-version':(item.version), "class": [('lib-item')] }, {"data-entity":true,"data-version":true})) + "><div class=\"lib-item-name\">" + (jade.escape((jade.interp = item.name) == null ? '' : jade.interp)) + "/" + (jade.escape((jade.interp = item.version) == null ? '' : jade.interp)) + "</div></li>");
}
    }
