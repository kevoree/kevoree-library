...
public class ContactsManager implements RosterListener {
    ...
    public void presenceChanged(Presence presence) {
        Log.debug(presence.getFrom() + " is now " + presence.getType());
        if(presence.getType() == Presence.Type.available) {
            Log.debug(presence.getFrom().substring(presence.getFrom().indexOf("/")) + " just Connected ! Triggering pending messages treatment");
