...
public class JsEngineTest {
    ...
    public void testBasic() throws Exception {
        final String res = jsEngine.evaluateFunction("function a() { return 1; }", "a", null);
        Assert.assertEquals("1", res);
    }

    @Test
    public void testCastStringParam1() throws Exception {
        final String res = jsEngine.evaluateFunction("function a(z) { return z+1; }", "a", "1");
        Assert.assertEquals("11", res);
    }

    @Test
    public void testCastStringParam2() throws Exception {
        final String res = jsEngine.evaluateFunction("function a(z) { return parseInt(z)+1; }", "a", "1.0");
    ...
    public void testWrongFunctionName() throws Exception {
        final String res = jsEngine.evaluateFunction("function a() { return 1; }", "b", null);
        Assert.assertEquals(1, res);
    }

    @Test
    public void testReturnJsonObject() throws Exception {
        final String o = jsEngine.evaluateFunction("function a(x) { return JSON.stringify({\"foo\": x }); }", "a", "bar");
