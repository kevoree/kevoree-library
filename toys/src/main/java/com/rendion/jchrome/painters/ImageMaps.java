...
public class ImageMaps
{
  ...
  public static void init(Theme aTheme)
  {
    ...
    tabJoins.put(TabState.selected, values("tab-f-l.gif", "tab-f-r.gif", "tab-f-span.gif", null, "tab-f-r-t.gif",
        "tab-f-r-t-h.gif"));

    tabJoins.put(TabState.notSelected, values("tab-f-l-ns.gif", "tab-f-r-ns.gif", "tab-f-span-ns.gif", "tab-f-r-ns-b.gif",
        "tab-f-r-ns-t.gif", "tab-f-r-ns-t-h.gif"));

    tabJoins.put(TabState.highlighted, values("tab-f-l-h.gif", "tab-f-r-h.gif", "tab-f-span-h.gif", "tab-f-r-h-b.gif",
    ...
    tabJoins.put(TabState.selected, values("tab-nf-l.gif", "tab-nf-r.gif", "tab-nf-span.gif", null, "tab-nf-r-t.gif", null));

    tabJoins.put(TabState.notSelected, values("tab-nf-l-ns.gif", "tab-nf-r-ns.gif", "tab-nf-span-ns.gif", "tab-nf-r-ns-b.gif",
